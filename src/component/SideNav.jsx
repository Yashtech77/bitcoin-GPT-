...
//   // ❌ Prevent new chat if the current session hasn't been used
...
//   // ✅ Optional: delete current session from backend if needed
//   const token = localStorage.getItem("token");
//   try {
//     await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/sessions/${currentSessionId}`, {
//       method: "DELETE",
//       headers: {
...
//     });
//   } catch (err) {
//     console.warn("Session delete failed (optional):", err);
//   }

//   // ✅ Create a new session
//   await createNewSession();
//   setHasUsedSession(false); // reset usage tracking
//   setLoading(false);
// };
